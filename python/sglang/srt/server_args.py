...
class ServerArgs:
    ...
    def __post_init__(self):
        ...
        self._handle_turboquant_transfer_compatibility()
    ...
    def _handle_turboquant_transfer_compatibility(self):
        ...
        validate_turboquant_transfer_compatibility(
            ...
            mla_fused_decode_enabled=envs.SGLANG_TQ_MLA_FUSED_DECODE.get(),
        )
