"""Native SM100 writer/front end for the N10 reciprocal-RoPE MLA ABI.
...
_MODULE_NAME = "sglang_tq_mla_frontend_sm100_a17_n10_w1_r3b_v1"
...
def tq_mla_n10_cache_writer_out(
...
def tq_mla_n10_frontend_rope_out(
    query_latent: torch.Tensor,
    query_rope: torch.Tensor,
    cache_latent: torch.Tensor,
    cache_rope: torch.Tensor,
