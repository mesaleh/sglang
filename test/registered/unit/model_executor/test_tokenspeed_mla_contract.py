...
def test_tq4_split_override_keeps_one_compact_graph_specialization():
    ...
    assert _tq4_split_override(batch_size=1, max_seq_len=10_000, num_sms=148) == 32
    assert _tq4_split_override(batch_size=8, max_seq_len=10_000, num_sms=148) == 32
    assert _tq4_split_override(batch_size=1, max_seq_len=256_000, num_sms=148) == 32
    assert _tq4_split_override(batch_size=8, max_seq_len=262_144, num_sms=148) == 32
...
def test_tq4_workspace_tracks_fixed_split_graph_shape():
    assert _tq4_workspace_bytes(8, 8, 512, 5, 32) == 21_012_480
